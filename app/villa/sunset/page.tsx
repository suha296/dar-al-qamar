...
import { ConversionTracker, initializeJourneyTracking } from '@/lib/analytics';
...
function SampleVilla() {
  ...
  const handleCheck = () => {
    ...
    // Track calendar search
    ConversionTracker.trackCalendarSearch(checkInISO, checkOutISO, 'main_page');
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center pt-0 px-2 sm:px-4 pb-80 w-full overflow-x-hidden" dir={dir}>
      ...
      <div className="w-full fixed top-0 left-0 right-0 z-50 bg-background bg-opacity-40 flex items-center justify-center h-20 md:h-24 shadow-sm">
        <div className="absolute left-4 flex items-center">
          <a
            ...
            aria-label="WhatsApp"
            onClick={() => ConversionTracker.trackCtaClick('whatsapp')}
          >
      ...
      <div className="flex justify-center gap-8 mb-4">
        <a href="https://wa.me/972533920842?text=Hi%2C%20I%20would%20like%20to%20reserve%20Dar%20Al%20Qamar%20villa." target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-3xl hover:scale-110 transition-transform" onClick={() => ConversionTracker.trackCtaClick('whatsapp')}>
